					...
					{useGradient ? (
						<div className="picker-head">
							<div className="gradient">
								渐变色
								<Switch checked={colorType === "gradient"} onChange={() => setColorType(colorType === "solid" ? "gradient" : "solid")} />
							</div>
							...
							<div className="picker-foot">
								<div className="types">
									{gradientType.map((gradient) => {
										return <div key={gradient} className={[gradient, gradientColor.type === gradient ? "--active" : ""].join(" ")} onClick={() => setGradientType(gradient as any)} />;
									})}
								</div>
